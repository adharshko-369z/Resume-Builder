            ...
            return (<div className="project-details-contanier" key={project.id}>
                ...
                <div className="input-cols-container">
                    <div className="label-input-error-container">
                        ...
                        <input type="text" id="projectTitle" name="projectTitle" {...commonAttributes} value={project.projectTitle} placeholder="Task Management App"   required/>
                        <p className="error-message" >{errors[`projectTitle_${project.id}`]}</p>
                    </div>
                    <div className="label-input-error-container">
                        <label htmlFor="technologies">Technologies</label>
                        <input type="text" id="technologies" name="technologies" {...commonAttributes} value={project.technologies} placeholder="React, JavaScript, CSS"   required/>
                        <p className="error-message" >{errors[`technologies_${project.id}`]}</p>
                    </div>
                </div>
                <div className="label-input-error-container">
                   <label htmlFor="description">Description</label>
                    <textarea rows="5" id="description" name="description" {...commonAttributes} value={project.description} placeholder="A responsive task management application with filtering and local data persistence."   required></textarea>
                    <p className="error-message" >{errors[`description_${project.id}`]}</p>
                </div>
                <div className="label-input-error-container">
                    <label htmlFor="projectGithubUrl">GitHub</label> 
                    <input type="url" id="projectGithubUrl" name="projectGithub" {...commonAttributes} value={project.projectGithub} placeholder="https://github.com/username/projectname"  />
